...
function monitorMatchStatus(matchId, boxId) {
  ...
  const interval = setInterval(async () => {
    ...
    // Skor + babak (selalu update saat live & selesai)
    ...
    if (event.status.type === "inprogress") {
      ...
      statusEl.innerText = ""; // Hilangkan tulisan kick off
    }
...
if (event.status.type === "finished") {
    ...
    const liveStatus = document.getElementById("liveStatus" + boxId);
    liveStatus.innerText = "⛔ MATCH ENDED ⛔";
    liveStatus.classList.add("blink");
    ...
    document.getElementById("liveScore" + boxId).innerHTML = scoreText;
