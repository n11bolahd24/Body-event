...
function loadSofaScore(matchId, matchKey) {
  ...
  // ⛑️ Fallback nama tim (jika Sofascore gagal)
  if (${fallbackTeams ? "true" : "false"}) {
    document.getElementById("teamshome${matchKey}").innerText =
      "${fallbackTeams?.home || ""}";
    document.getElementById("teamsaway${matchKey}").innerText =
      "${fallbackTeams?.away || ""}";
  }
