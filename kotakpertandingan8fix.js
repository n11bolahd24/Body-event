...
function renderMatch(matchId, matchKey, serverFuncs, boxClass = "kotak") {
  ...
  <div class="${boxClass}" id="match${matchKey}" class="kotak matchbox">
    ...
    <div class="club">
      <center>
        <span id="league${matchKey}" style="position:relative; top:5px; left:-11px; font-family:Tahoma, sans-serif; font-weight:bold; font-size:12px; color:white;">NAMA LIGA</span>
        <div id="liveScore${matchKey}" style="position:relative; top:0px; left:0px;font-size:20px; font-family:Tahoma, sans-serif; font-weight:bold; color:orange; text-align:center;"></div>  
        <div id="matchStatus${matchKey}" style="font-family:Tahoma, sans-serif; font-size:10px; font-weight:bold; color:orange; text-align:center; margin:-1px 1px;"></div>   
