  ...
  Refresh Or Setting Your DNS
    ...
    ">
      ...
      <div style="flex:1; display:flex; justify-content:flex-end; align-items:center; gap:8px;">
        ...
        <img id="logoHome${matchKey}" style="height:45px; width:45px; border-radius:5px; margin-right:10px;">
      </div>
      ...
      <div style="flex:1; display:flex; justify-content:flex-start; align-items:center; gap:8px;">
        <img id="logoAway${matchKey}" style="height:45px; width:45px; border-radius:5px; margin-left:10px;">
    ...
    <!-- Info Lain -->
    <div id="matchStatus${matchKey}" style="margin-top:-10px; margin-bottom:0px; text-align:center; font-family:'Courier New', monospace; font-size:10px; font-weight:bold; color:orange;">UP COMING</div>
