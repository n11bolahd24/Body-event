  ...
  ">
    ...
    <div style="flex:1; display:flex; justify-content:flex-end; align-items:center; gap:8px;">
      ...
      <img id="logoHome${matchKey}" 
           style="height:45px; width:45px; border-radius:5px; margin-right:15px; filter: drop-shadow(0 0 1.5px rgba(0,0,0,0.8));
">
    </div>
    ...
    <div style="flex:1; display:flex; justify-content:flex-start; align-items:center; gap:8px;">
      <img id="logoAway${matchKey}" 
           style="height:45px; width:45px; border-radius:5px; margin-left:15px; filter: drop-shadow(0 0 1.5px rgba(0,0,0,0.8));
">
  ...
  <div id="tvCountdown${matchKey}" 
       style="font-size:10px; margin-top:3px; margin-bottom:3px; color: yellow; font-style:italic; text-shadow:
        0 0 2px #000,
        0 0 4px #000,
        0 0 6px #000,
        0 0 8px #000;">
