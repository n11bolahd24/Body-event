  ...
  <div class="${boxClass}" id="match${matchKey}" class="kotak matchbox">
    ...
    <div class="club">
      <center>
        ...
        <div id="liveScore${matchKey}" style="position:relative; top:0px; left:0px;font-size:20px; font-family:'Courier New', monospace; font-weight:bold; color:orange; text-align:center;"></div>  
