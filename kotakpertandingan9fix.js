...
function renderMatch(matchId, matchKey, serverFuncs, boxClass = "kotak") {
  ...
  <div class="${boxClass}" id="match${matchKey}" class="kotak matchbox">
    ...
    <div class="club">
      <center>
        <span id="league${matchKey}" style="position:relative; top:5px; left:-11px; font-family:Verdana, sans-serif; font-weight:bold; font-size:12px; color:white;">NAMA LIGA</span>
