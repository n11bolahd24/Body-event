  ...
  ">
    ...
    <div style="flex:1; display:flex; justify-content:flex-end; align-items:center; gap:8px;">
      ...
      <img id="logoHome${matchKey}" 
           style="height:45px; width:45px; border-radius:5px; margin-right:15px; filter: drop-shadow(0 0 2.5px rgba(0,0,0,0.8));
">
    </div>
    ...
    <div style="flex:1; display:flex; justify-content:flex-start; align-items:center; gap:8px;">
      <img id="logoAway${matchKey}" 
           style="height:45px; width:45px; border-radius:5px; margin-left:15px; filter: drop-shadow(0 0 2.5px rgba(0,0,0,0.8));
">
