...
async function playIKOTVStream(
  ...
  if (isMPD) {
    ...
    try {
      ...
      if (
        ...
        console.warn(
          "[IKOTV] MPD tidak memiliki ClearKey"
        );
  ...
  console.warn(
    "[IKOTV] Format stream tidak dikenal:",
    url
  );
